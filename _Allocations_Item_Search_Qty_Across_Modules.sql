...
Begin
 print 'Allocated Orders in Sales Order Processing - SOP10200 Type 2'
select SOPNUMBE,ITEMNMBR,ITEMDESC,ATYALLOC from SOP10200 where ITEMNMBR = @ITEMNMBR and ATYALLOC > 0 and  SOPTYPE = 2
end

if exists (select * from sysobjects where name ='SOP10200 SOP10200 Type 3')
Begin
...
if exists (select * from sysobjects where name ='SOP10200 SOP10200 Type 6')
Begin
...
print 'Allocated Service Call Transfers - SVC00701'
print '==============================================================='
print ''
...
print 'Allocated Service Call Transfers (serial) - SVC00702'
print '==============================================================='
print ''
